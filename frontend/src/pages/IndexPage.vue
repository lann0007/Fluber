<template>
  <q-page class="column items-center">
    ...
    <p class="q-px-md">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean at vehicula purus. Suspendisse eu
      lacus purus.
      Nunc ut varius nulla. Ut pharetra quam vitae dolor lacinia, vel elementum enim fringilla. Quisque convallis tellus
      in interdum blandit. Ut nec dolor nisl. Aenean lobortis massa ut faucibus tempus. Quisque feugiat, metus id
